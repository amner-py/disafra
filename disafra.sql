...
CREATE TABLE IF NOT EXISTS SUCURSAL(
	...
	TELEFONO_NUM VARCHAR(16) NOT NULL
)ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS PERMISO_USUARIO_SUCURSAL(
	ID_PERMISO_USUARIO_SUCURSAL INT NOT NULL,
	SUCURSAL_USUARIO VARCHAR(50) NOT NULL,
    PERMISO VARCHAR(30) NOT NULL
)ENGINE=InnoDB;
...
ALTER TABLE PERMISO_USUARIO_SUCURSAL
ADD CONSTRAINT PK_PERMISO_USUARIO_SUCURSAL
PRIMARY KEY(ID_PERMISO_USUARIO_SUCURSAL);
...
ADD CONSTRAINT PK_SUB_CATEGORIA
...
ALTER TABLE CLIENTE
ADD CONSTRAINT FK_CLIENTE_USUARIOCLIENTE
...
ALTER TABLE PERMISO_USUARIO_SUCURSAL
ADD CONSTRAINT FK_PERMISOUSUARIOSUCURSAL_PERMISO
FOREIGN KEY(PERMISO) REFERENCES PERMISO(PERMISO)
ON UPDATE CASCADE
ON DELETE CASCADE;

ALTER TABLE PERMISO_USUARIO_SUCURSAL
ADD CONSTRAINT FK_PERMISOUSUARIOSUCURSAL_USUARIOSUCURSAL
...
ALTER TABLE SUB_CATEGORIA
ADD CONSTRAINT FK_SUBCATEGORIA_PRODUCTO
